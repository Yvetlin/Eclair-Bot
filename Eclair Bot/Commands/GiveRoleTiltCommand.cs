...
{
    public class GiveRoleTiltCommand : ModuleBase<SocketCommandContext>
    {
        [Command("GiveRole Tilt")]
        //     [RequireUserPermission(Discord.GuildPermission.Administrator)]
        public async Task TiltTask(string user)
        {
            ...
            userId = userId.Replace(">", "");
                    ...
                    eb.WithDescription($"Пользователю <@!{userId}>, выдана роль - Тильт.");
            ...
            if (user1.GuildPermissions.Administrator)
            {
                ...
                addRole(889075599677747221); //айди роли
