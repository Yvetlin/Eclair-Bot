...
{
    public class GiveRoleHedgeCommand : ModuleBase<SocketCommandContext>
    {
        [Command("GiveRole Hedge")]
   //     [RequireUserPermission(Discord.GuildPermission.Administrator)]
        public async Task HedgeTask(string user)
        {
            ulong channelid = Context.Channel.Id;

            if (!channelid.Equals(889227038093893663)) //выбор канала
                return;
            ...
            userId = userId.Replace(">", "");
                    ...
                    eb.WithDescription($"Пользователю <@!{userId}>, выдана роль - Клан йежат");
            ...
            if (user1.GuildPermissions.Administrator)
            {
                ...
                addRole(894543834564923412); //айди роли
