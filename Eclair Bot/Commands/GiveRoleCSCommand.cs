...
{
    public class GiveRoleCSCommand : ModuleBase<SocketCommandContext>
    {
        [Command("GiveRole CS")]
        //     [RequireUserPermission(Discord.GuildPermission.Administrator)]
        public async Task CSTask(string user)
        {
            ...
            eb.WithDescription($"Пользователю <@!{userId}>, выдана роль - Большая кучка.");
            ...
            if (user1.GuildPermissions.Administrator)
            {
                ...
                addRole(929546001788850277); //айди роли
