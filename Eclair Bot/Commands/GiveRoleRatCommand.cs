...
{
    public class GiveRoleRatCommand : ModuleBase<SocketCommandContext>
    {
        [Command("GiveRole Rat")]
        //     [RequireUserPermission(Discord.GuildPermission.Administrator)]
        public async Task RatTask(string user)
        {
            ...
            userId = userId.Replace(">", "");
                    ...
                    eb.WithDescription($"Пользователю <@!{userId}>, выдана роль - Крыска.");
            ...
            if (user1.GuildPermissions.Administrator)
            {
                ...
                addRole(888924659637162026); //айди роли
